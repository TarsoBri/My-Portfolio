        ...
        <div className="about_content">
          ...
          <div className="about_texts">
            <p>
              ...
              no que faço, buscando sempre a segurança e a satisfação do
              cliente, que tal trabalharmos juntos em um projeto? Sou um cara
              comunicativo e que se da muito bem com as pessoas. Veja meu
              currículo virtual abaixo para mais detalhes sobre mim.
            </p>
